...
#
#   https://my-hospital-pharm.procaryote.com/?backend=restApi&api=https://lab-api.example
#
# Requires: the Firebase CLI, and `firebase login` (once).
set -euo pipefail

TARGET="pharm"
SITE="my-hospital-2026-pharm"
...
DOMAIN="my-hospital-pharm.procaryote.com"
...
echo "Building PHARM for the web (backend: $BACKEND, auth: $AUTH)..."
