...
List<IntegrationFlow> buildSeedFlows(DateTime now) => <IntegrationFlow>[
      IntegrationFlow(
        ...
        description: const LocalizedText(
          en: 'Takes every reading the connected devices publish, checks it is '
              'valid FHIR, adds the patient demographics, then stores it on the '
              'FHIR server and pushes it to the EHR.',
          fr: 'Reçoit chaque mesure publiée par les appareils connectés, vérifie '
              ...
              "transmet à l'EHR.",
          nl: 'Ontvangt elke meting van de aangesloten apparaten, controleert of '
      ...
      IntegrationFlow(
        ...
        description: const LocalizedText(
          en: 'Watches the oxygen saturation readings and raises an alert when '
              'one drops below 92%. Everything else is dropped, so the alert '
              'channel stays quiet until it matters.',
          fr: 'Surveille les mesures de saturation en oxygène et déclenche une '
          ...
          nl: 'Bewaakt de zuurstofsaturatiemetingen en slaat alarm zodra er een '
